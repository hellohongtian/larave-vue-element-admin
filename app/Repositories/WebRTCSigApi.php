...
class WebRTCSigApi {
    ...
    public function __construct($appName) {
        ...
        $this->sdkappid = config("tecentCloudConfig.appName.".$appName.".sdkappid");
        $this->private_key = config("tecentCloudConfig.appName.".$appName.".privateKey");
        $this->public_key = config("tecentCloudConfig.appName.".$appName.".publicKey");
    }
     ...
     */
    public function genUserSig($userid, $expire = 36000) {
        $json = Array(
            'TLS.account_type' => '0',
